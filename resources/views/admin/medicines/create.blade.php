    ...
    <div
        ...
        <div>
            ...
            <h2 class="text-2xl md:text-3xl font-extrabold flex items-center gap-2">
                <i class="fas fa-capsules text-white/90"></i>
            ...
            <div class="flex items-center gap-3 mb-5 pb-3 border-b border-gray-100">
                ...
                <div>
                    <p class="text-xs font-semibold tracking-wide text-emerald-700 uppercase">
                        Form Tambah Obat / Tindakan
                    </p>
                    <p class="text-[11px] text-gray-500">
                        Isi informasi dasar dengan jelas agar mudah dipahami petugas dan pasien.
                    </p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.medicines.store') }}"
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-[11px] text-gray-400">
                        Pilih <strong>Obat</strong> untuk obat farmasi, atau <strong>Tindakan</strong> untuk layanan medis.
                    </p>
                </div>
