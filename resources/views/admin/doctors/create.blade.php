    ...
    <div
        ...
        <div>
            ...
            <h1 class="text-2xl md:text-3xl font-extrabold flex items-center gap-2">
                <i class="fas fa-user-plus text-white/90"></i>
                Tambah Dokter Baru
            </h1>
            <p class="text-sm text-teal-100 mt-1 max-w-xl">
                Buat akun dan profil dokter baru untuk sistem rumah sakit.
            </p>
        </div>
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500">
                                Data login untuk digunakan dokter pada sistem.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="bio" id="bio" rows="3"
                                      class="w-full px-3 py-2.5 rounded-lg border border-gray-300 text-sm shadow-sm
                                             focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500
                                             @error('bio') border-rose-500 focus:ring-rose-400 focus:border-rose-500 @enderror">{{ old('bio') }}</textarea>
                            @error('bio')
                                <p class="text-rose-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
