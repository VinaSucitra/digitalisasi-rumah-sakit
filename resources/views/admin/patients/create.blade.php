    ...
    <div
        ...
        <div>
            ...
            <h1 class="text-2xl md:text-3xl font-extrabold flex items-center gap-2">
                <i class="fas fa-user-injured text-white/90"></i>
                Tambah Pasien Baru
            </h1>
            <p class="text-sm text-teal-100 mt-1 max-w-xl">
                Admin dapat membuat akun pasien beserta data profilnya.
            </p>
        </div>
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500">
                                Data login yang digunakan pasien untuk mengakses sistem.
                            </p>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3 mb-1">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500">
                                Informasi dasar pasien untuk kebutuhan rekam medis.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="w-full px-3 py-2.5 rounded-lg border border-gray-300 text-sm shadow-sm
                                         focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500
                                         @error('address') border-rose-500 focus:ring-rose-400 focus:border-rose-500 @enderror">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="text-rose-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
