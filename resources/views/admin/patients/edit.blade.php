...
<div class="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500">Perbarui data akun dan profil pasien.</p>
        </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" value="{{ $detail->no_rm ?? '-' }}" disabled
                               class="w-full px-3 py-2 rounded-lg border border-gray-200 bg-gray-50 text-sm shadow-sm">
                    </div>
                    <div>
                ...
                <div class="mb-2">
                    ...
                    <textarea name="address" rows="3"
                              class="w-full px-3 py-2 rounded-lg border border-gray-300 text-sm shadow-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('address') border-rose-500 @enderror">{{ old('address', optional($detail)->address) }}</textarea>
